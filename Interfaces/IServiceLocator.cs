...
namespace PEPErvice.Interfaces
{
	...
	public interface IServiceLocator
	{
		...
		void Bind<TService>(Func<TService> resolver, Lifetime lifetime = Lifetime.Singleton) where TService : class, IService;
		TService Resolve<TService>() where TService : class, IService;
		void Unbind<TService>() where TService : class, IService;
		void Register<TService>(IService service, Lifetime lifetime = Lifetime.Singleton) where TService : class, IService;
